...
function ATSProPDF({ data, langue = "fr" }: { data: CVOptimise; langue?: "fr" | "en" }) {
  ...
  const s = StyleSheet.create({
    page: { fontFamily: "Inter", backgroundColor: C.white, paddingTop: 54, paddingBottom: 54, paddingHorizontal: 66 },
    name: { fontFamily: "Inter", fontWeight: 700, fontSize: 17, color: C.black, marginBottom: 3 },
    titleLine: { fontFamily: "Inter", fontWeight: 400, fontSize: 10.5, color: "#333", marginBottom: 5 },
    contactLine: { fontFamily: "Inter", fontWeight: 300, fontSize: 9, color: "#333", marginBottom: 18 },
    sectionTitle: {
      fontFamily: "Inter", fontWeight: 700, fontSize: 9.5,
    ...
    coreGrid: { flexDirection: "row", flexWrap: "wrap", marginBottom: 4 },
    coreItem: { fontFamily: "Inter", fontWeight: 400, fontSize: 9, color: "#1a1a1a", marginRight: 20, marginBottom: 4 },
    ...
    bullet: { fontFamily: "Inter", fontWeight: 300, fontSize: 9, color: "#1a1a1a", lineHeight: 1.55, marginLeft: 10, marginBottom: 2 },
    ...
    langText: { fontFamily: "Inter", fontWeight: 300, fontSize: 9, color: "#1a1a1a", lineHeight: 1.7 },
  });
